...
git remote add origin https://github.com/dilitalcreatorss-design/umang.git 2>$null
if (-not $?) { git remote set-url origin https://github.com/dilitalcreatorss-design/umang.git }
...
Write-Host "Done! Repository: https://github.com/dilitalcreatorss-design/umang"